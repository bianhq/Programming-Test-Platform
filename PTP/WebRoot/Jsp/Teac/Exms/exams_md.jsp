...
#state,#id_time {
	...
	<body style="font-family: 华文楷体" onload="setCate()">
		<h2>
			考试设置
		</h2>
		<div class="addex">
			<form method="post" action="md_exam.action" onsubmit="return check()">
					...
					<tr>
						...
						<td>
							<input class="inp" type="text" id="id_examName" name="examName"
								value='<s:property value="examName"/>'>
						</td>
						<td>
							类别:
						</td>
					...
					<tr>
						...
						<td>
							<input class="inp" type="text" id="id_sTime" name="startTime"
								...
								onchange="setLast()" value='<s:property value="startTime"/>'>
						</td>
						<td>
							结束时间:
						</td>
						<td>
							<input class="inp" type="text" id="id_eTime" name="endTime"
								onclick="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm:ss'})"
								onchange="setLast()" value='<s:property value="endTime"/>'>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input class="inp" type="text" id="id_time" name="last"
								readonly="readonly" value='<s:property value="last"/>'>
						</td>
						<td>
							状态:
						</td>
						<td>
							<input class="inp" type="text" id="state" name="pass"
								value='<s:property value="pass"/>' readonly="readonly">
						</td>
					</tr>
				</table>
